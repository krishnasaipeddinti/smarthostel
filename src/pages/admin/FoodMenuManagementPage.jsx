...
function FoodMenuManagementPage() {
  ...
  return (
    <PageShell
      title="Food Menu"
      subtitle="Edit weekly hostel food menu."
    >
          ...
          <div key={item.id} className="glass rounded-3xl p-5 shadow-2xl">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <input
                ...
                onChange={(e) =>
                  handleChange(item.id, "breakfast", e.target.value)
                }
              ...
              <input
                ...
                value={item.lunch}
                onChange={(e) =>
                  handleChange(item.id, "lunch", e.target.value)
                }
                placeholder="Lunch"
              />
              ...
              <input
                ...
                value={item.snacks}
                onChange={(e) =>
                  handleChange(item.id, "snacks", e.target.value)
                }
                placeholder="Snacks"
              />
              ...
              <input
                ...
                value={item.dinner}
                onChange={(e) =>
                  handleChange(item.id, "dinner", e.target.value)
                }
                placeholder="Dinner"
              />
            </div>
